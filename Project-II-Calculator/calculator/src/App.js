...
class App extends React.Component {
    render() {
        return (<div className='calc-wrapper' > <CalculatorDisplay /> {
            /* answer line */
        }
            <div className='row'>
            ...
            <div className='row'> <NumberButton bgColor='num-button small-btn' text='7' />
                <NumberButton bgColor='num-button small-btn' text='8' />
                <NumberButton bgColor='num-button small-btn' text='9' />
                <NumberButton bgColor='action-button small-btn' text={'\u00D7'} />
            </div>
            <div className='row'> <NumberButton bgColor='num-button small-btn' text='4' />
